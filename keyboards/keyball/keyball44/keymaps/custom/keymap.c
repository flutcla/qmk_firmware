...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_universal(
    ...
    KC_LSFT  , KC_Z     , KC_X     , KC_C     , KC_V     , KC_B     ,                                        KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_QUOT  , KC_BSPC  ,
  ...
  [1] = LAYOUT_universal(
    ...
    KC_LSFT  , KC_EQUAL , KC_PLUS  , KC_MINUS , KC_ASTR  , KC_SLASH ,                                         KC_BSLS  , KC_GRV   , _______  , KC_LBRC  , KC_RBRC  , _______  ,
